...
use App\Http\Controllers\Api\MeGachaController;
use App\Http\Controllers\Api\MeInventoryController;
use App\Http\Controllers\Api\MeHomeMediaController;
use App\Http\Controllers\Api\MeAlbumController;
use App\Http\Controllers\Api\MePointsController;
use App\Http\Controllers\Api\MePointsAwardShareController;
use App\Http\Controllers\Api\MePointsEarnController;
...
Route::delete('/me/account', [AccountDeleteController::class, 'destroy']);
...
Route::post('/me/points/award-share', [MePointsAwardShareController::class, 'store']);
...
Route::post('/me/media/home', [MeHomeMediaController::class, 'store']);
Route::get('/me/album', [MeAlbumController::class, 'index']);
Route::post('/me/album', [MeAlbumController::class, 'store']);
Route::get('/me/album/{album}', [MeAlbumController::class, 'show']);
Route::delete('/me/album/{album}', [MeAlbumController::class, 'destroy']);
